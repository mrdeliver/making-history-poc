...
export default class SourceSelector extends Vue {
  getRessourceIdsOfTypeForPage(pageRessources: Ressources, type: RessourceType): string[] {
    switch (type) {
      ...
      case RessourceType.MULTI_IMAGE_SOURCE:
        return pageRessources.multiImageSources;
      default:
        return [];
    }
  }
  ...
  getRessourcesForIds(ressourceIds: string[], type: RessourceType): Ressource[] {
    switch (type) {
      ...
      case RessourceType.MULTI_IMAGE_SOURCE:
        return RessourceStore.multiImageRessourcesWithIds(ressourceIds);
      default:
        return [];
    }
  }
  ...
  getCurrentRessource(ressourceId: string, type: string): Ressource {
    switch (type) {
      ...
      case RessourceType.MULTI_IMAGE_SOURCE:
        return RessourceStore.multiImageRessource(ressourceId);
      default:
        return {} as Ressource;
    }
  }
