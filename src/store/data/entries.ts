  ...
  result: {
    entries: [
      ...
      },
      {
        ...
        type: EntryType.METHOD,
        heading: 'Themen-ABC',
        goal: 'Das Ziel ist es, möglichst zu allen Buchstaben des Alphabets Begriffe zu einem neuen oder bereits erarbeiteten Thema zu assoziieren und diese zu notieren. Diese Methode kann gut für den Unterrichtseinstieg verwendet werden, um dem Lehrenden einen Überblick über den Wissensstand der Lernenden zu geben',
